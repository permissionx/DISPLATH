function Element(name::String, dte::Float64, bde::Float64)
    ...
    elseif name == "He"
        return Element(name, 0.31, 4.0, 2.0, dte, bde, 1.5, 0.05)
    elseif name == "Li"
        return Element(name, 1.67, 7.0, 3.0, dte, bde, 1.5, 0.05)
    elseif name == "Be"
        return Element(name, 1.12, 9.0, 4.0, dte, bde, 1.5, 0.44) 
    elseif name == "B"
        return Element(name, 0.87, 11.0, 5.0, dte, bde, BAlpha, BBeta)  # BAlpha = 1.5  BBeta = 0.44
    elseif name == "C"
    ...
    elseif name == "Si"
        return Element(name, 0.25, 28.0, 14.0, dte, bde, 1.0, 0.44)     # shrinked radius  1.11
    elseif name == "P"
